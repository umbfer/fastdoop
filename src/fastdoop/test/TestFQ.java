...
/**
 * A Simple Hadoop application useful to test {@code FASTAQInputFileFormat}.
 * 
 * @author Gianluca Roscigno
 * 
 * @version 1.0
 * 
 * @see FASTAQInputFileFormat
 */


public class TestFQ extends Configured implements Tool {
	
	public static void main(String args[]) {
		if (args.length<1){
			System.out.println("Usage: TestFQ input_file");
			System.exit(1);
		}

		try {
			ToolRunner.run(new TestFQ(), args);
		} catch (Exception e) {
